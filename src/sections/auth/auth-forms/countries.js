const countries = [
    ...
    {
      code: 'KP',
      label: 'Coreia, República Democrática Popular da',
      phone: '850',
    },
    ...
    { code: 'PN', label: 'Ilhas Pitcairn', phone: '870' },
    { code: 'PR', label: 'Porto Rico', phone: '1' },
    { code: 'PS', label: 'Território Palestino', phone: '970' },
    ...
    { code: 'SH', label: 'Santa Helena, Ascensão e Tristão da Cunha', phone: '290' },
    ...
    {
      code: 'TW',
      label: 'Taiwan, Província da China',
      phone: '886',
    },
    ...
    { code: 'VA', label: 'Santa Sé (Estado da Cidade do Vaticano)', phone: '379' },
    {
      code: 'VC',
